...
$sql="SELECT `id`, `studentid`, `mobilenumber`, `firstname`, `lastname`, `fathername`, `mothrename`, `email`, `aadharno`, `gender`, `dob`, `family`, `village`, `police`, `district`, `zip`, `staffid`, `imges` FROM `studentmail` WHERE 1";
...
while($row=mysqli_fetch_array($result)){
  ...
  <td><button style="background-color:green;color:white;border:none;font-size:25px" data-bs-toggle="modal" data-bs-target="#view<?php echo $row['id']?>"><i class="fa fa-id-card" aria-hidden="true"></i></button></td>

  <td><button style="background-color:gold;color:white;border:none;font-size:25px"
    data-bs-toggle="modal" data-bs-target="#edit<?php echo $row['id']?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></td>

    <td>
    <a href="delete.php?id=<?php echo $row['id']?>"><button style="background-color:red;color:white;border:none;font-size:25px;"><i class="fa fa-trash" aria-hidden="true"></i></button></td>
