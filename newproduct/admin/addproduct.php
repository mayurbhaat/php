    ...
    ?>
        ...
        <div class="content">
                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form method="Post"  enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text"  name="pcat"  class="form-control" id="exampleInputPassword1">
                                </div>

                                
                                <div class="mb-3">
                                    <label for="exampleInputPassword1" class="form-label">delete price</label>
                                    <input type="number"  name="dprice"  class="form-control" id="exampleInputPassword1">
                                </div>
            ...
            if(isset($_POST['submit'])){
             ...
             $sql="INSERT INTO `product`(`image`, `pname`, `pcat`, `dprice`, `price`) VALUES ('$img','$pname','$pcat','$dprice','$price')"; 
