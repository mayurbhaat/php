...
<body style="background-color:honeydew">
	...
	<div class="container">
		<h2 class="text-center">Student Record System</h2><br><br>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title text-center">Add New Card</h4>
				</div>
			...
			<div class='container' id='profile'> 
				<div class='row'>
					<div class='col-sm-4 col-md-2'>
						<img src='images/$image' alt='' style='width: 150px; height: 150px;' ><br>
